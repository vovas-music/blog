...
*Links to song: [Spotify](https://spti.fi/tango) • [SoundCloud](https://soundcloud.com/vzkrv/disintegration-tango) • [YouTube](https://youtu.be/Ps3bXFmpVCA)*
...
But [this one](https://spti.fi/tango) is the first time I got to releasing a restored version of one of my old Jukebox songs. This one is called “Disintegration Tango,” and it was one of the better-sounding ones I had back then. Still, even with all the tips & tricks for improving quality, even the best Jukebox sound pales in comparison to what Suno can do today, so I was excited to see what I could do with it.
<!-- TODO: Add info about improving quality for Jukebox songs -->

First of all, [here’s](/media/tango-jukebox.mp3?raw=true) the original Jukebox song for reference.

https://github.com/user-attachments/assets/a4db96c9-83bc-4093-93d3-cd867e911f6b
<!-- ^^ to embed the audio file if viewing in GitHub -->
<!-- TODO: Remove when posting to Reddit -->

So, now to the promised thoughts and tips:
...
So in the end I decided I would take the [best intro I could get](https://suno.com/song/99898d4f-c640-4c97-8e87-db3d3feea88b) and then merge it with the [best heavy part I could get](https://suno.com/song/68aa326a-e01b-4ada-8e48-ba4007664edd). And that’s exactly what I did, merging them together in REAPER:

![Screenshot of a REAPER project with two takes, one for the intro and one for the heavy part, merged together.](/media/tango-intro-merge.png)
...
<!-- TODO: add a link to the PSCHPTHY album when it's released -->
...
<!-- TODO: Add the links to the generations, including the one below -->
...
First, try stitching right before transients such as drum hits, cymbal crashes, or guitar strums with short (20–30 ms) crossfades:

![Screenshot of a REAPER project with two takes stitched together with a short crossfade.](/media/tango-stitching.png)
